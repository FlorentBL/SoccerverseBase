  ...
  return (
    <div className="min-h-screen text-gray-100">
      ...
      <section className="relative flex flex-col items-center justify-center text-center py-32">
        ...
        />
        <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-fuchsia-400 via-indigo-400 to-sky-400 bg-clip-text text-transparent drop-shadow-xl mb-6">
          {t.hero1}
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-xl">
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-fuchsia-500 to-sky-500 px-8 py-4 text-lg font-bold shadow-xl transition-opacity hover:opacity-90 w-full"
          >
          ...
          <a
            href="https://play.soccerverse.com?ref=klo&pack=https://elrincondeldt.com/sv/rincon_v1.json"
            target="_blank" rel="noopener"
            className="flex items-center justify-center gap-2 rounded-full bg-white/10 hover:bg-white/20 px-8 py-4 text-lg font-bold backdrop-blur w-full transition"
          >
