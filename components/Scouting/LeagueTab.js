...
const GROUP_LABELS = {
  AFR: { fr: "Afrique", en: "Africa", it: "Africa", zh: "非洲" },
  AME: { fr: "Amérique", en: "America", it: "America", zh: "美洲" },
  ASI: { fr: "Asie", en: "Asia", it: "Asia", zh: "亚洲" },
  EUR: { fr: "Europe", en: "Europe", it: "Europa", zh: "欧洲" },
};

const SPECIAL_COUNTRIES = {
  ENG: { fr: "Angleterre", en: "England", it: "Inghilterra", zh: "英格兰" },
  SCO: { fr: "Écosse", en: "Scotland", it: "Scozia", zh: "苏格兰" },
  WAL: { fr: "Pays de Galles", en: "Wales", it: "Galles", zh: "威尔士" },
  NIR: { fr: "Irlande du Nord", en: "Northern Ireland", it: "Irlanda del Nord", zh: "北爱尔兰" },
};
...
const T = {
  ...
  en: {
    ...
    zh: {
      ...
      seasonNames: { S1: "赛季 1", S2: "赛季 2" },
      showTable: "显示排名",
      searching: "搜索中...",
      loadingDetails: "载入俱乐部数据...",
      errorNetwork: "网络或解析错误。",
      noLeague: "未找到联赛或没有球队。",
      standingsTitle: "排名",
      championshipLabel: "联赛:",
      columns: {
        rank: "#",
        club: "俱乐部",
        manager_name: "教练",
        ...
        goals_against: "失球",
        fanbase: "粉丝",
        stadium_size_current: "球场",
        avg_player_rating: "评分",
        avg_wages: "💸平均",
        total_wages: "💸总额",
        total_player_value: "🏦价值",
        balance: "余额",
        transfers_in: "入",
        transfers_out: "出",
        avg_player_rating_top21: "Top21",
